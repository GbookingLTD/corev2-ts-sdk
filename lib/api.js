...
exports.JsonRpcMedMeAPI = exports.AMedMeAPI = exports.initJsonRpcMedMeAPI = exports.MedMeAPI = void 0;
...
var prodJsonRpcEnv_1 = require("./prodJsonRpcEnv");
/**
 * Initialize MedMeAPI as JsonRpc API
 */
function initJsonRpcMedMeAPI(env) {
    if (env === void 0) { env = prodJsonRpcEnv_1["default"]; }
...
var AMedMeAPI = /** @class */ (function () {
    function AMedMeAPI(apiRequest) {
        this.business =
            new business_1.MedMeAPIBusiness(apiRequest);
        this.client =
            new client_1.MedMeAPIClient(apiRequest);
        this.appointment =
            new appointment_1.MedMeAPIAppointment(apiRequest);
    }
    /**
