...
export const CRAC_API_ENDPOINT: string = "http://crac-prod.gbooking.ru/rpc";
export const CRAC3_API_ENDPOINT: string = "http://crac-prod3.gbooking.ru/rpc";
export const OAUTH_OTP_SEND: string = "http://oauth.dev.gbooking.ru/sms/code";
export const OAUTH_OTP_VERIFY: string = "http://oauth.dev.gbooking.ru/sms/verify";
export const OAUTH_OTP_WEBLOGIN: string = "http://oauth.dev.gbooking.ru/web_login";

export const API_REQUEST_DEBUG: boolean = false;
export const OTP_REQUEST_DEBUG: boolean = false;